...
MonMenuIcons:
	...
	db ICON_MONSTER     ; ZYGARDE
	db ICON_BIRD        ; PARASECT
	db ICON_CATERPILLAR ; LARVESTA
	db ICON_MOTH        ; VOLCARONA
	db ICON_MONSTER     ; ARCTOZOLT
	...
	db ICON_PIKACHU     ; MARILL
	db ICON_PIKACHU     ; AZUMARILL
